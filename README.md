# CatBook
Welcome to CatBook! A social networking app for cats. This full stack web application allows users to facilitate connections through photo sharing. This README provides an overview of the project and key features.
